...
for (k in 1:m){
  ...
  if (k %% 10 == 0) {
    ...
    saveRDS(pvalue_results, file = paste0('/home/zhiweixu/pmi/Power/pvalues_d',d,'_n',n,'_clen',c_len,'_ord',abs(ord),'.rds'))
    saveRDS(pvalue_patient_level_results, file = paste0('/home/zhiweixu/pmi/Power/pvalues_patlevel_d',d,'_n',n,'_clen',c_len,'_ord',abs(ord),'.rds'))
    ...
    write.csv(min_pvalues_df, file = paste0('/home/zhiweixu/pmi/Power/minpvalue_d',d,'_n',n,'_clen',c_len,'_ord',abs(ord),'.csv'), row.names = FALSE)
...
write.csv(min_pvalues_df, file = paste0('/home/zhiweixu/pmi/Power/final_minpvalue_d',d,'_n',n,'_clen',c_len,'_ord',abs(ord),'.csv'), row.names = FALSE)
